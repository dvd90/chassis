...
/**
 * Postgres-backed magic-link credentials. Shape-compatible with `MagicStore`
 * in ../magic.ts, which imports it by feature flag; nothing here depends on
